The project planification can be broken down to fours main phases, those of Analysis, Documentation \& Specification, Development \& Testing, and the MVP. Following a more detailed explanation of each of one:
